...
# Training the model
scinet_model.fit(x_train, y_train, epochs=100, batch_size=batch_size, validation_split=0.2, verbose=1)
...
save_y_test_predicted_values.to_excel('Predicted values of Vancouver-SCINet.xlsx', index=False)
save_y_test_real_values = pd.DataFrame(y_test_real_values)
save_y_test_real_values.to_excel('Real values of Vancouver-SCINet.xlsx', index=False)
...
eva_test.to_excel('Vancouver-SCINet.xlsx', index=False)
