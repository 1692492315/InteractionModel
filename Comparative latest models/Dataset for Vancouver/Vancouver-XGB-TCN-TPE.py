...
save_y_test_predicted_values.to_excel('Predicted values of Vancouver-XGB-TCN-TPE.xlsx', index=False)
save_y_test_real_values = pd.DataFrame(y_test_real_values)
save_y_test_real_values.to_excel('Real values of Vancouver-XGB-TCN-TPE.xlsx', index=False)
...
eva_test.to_excel('Vancouver-XGB-TCN-TPE.xlsx', index=False)
